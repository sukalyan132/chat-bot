...
*/
          ...
          'children': [{
                      'tagName': 'div',
                       'classNames': ['media' ] ,
                       'html':'<a class="pull-left" target="_blank" href="sme.html?sme='+valueobj.sme_id+'&'+sectorparameterString+'='+encodedSectorsString+'&'+countryparameterString+'='+encodedCountryString+'&score='+valueobj.total_score+'"><img class="media-object img-circle" style="max-height:40px;" src="images/dummy.jpg" /></a>', 
                        'children':[{
                            'tagName': 'div',
                            'classNames': ['media-body'] ,
                             'html' : ( '<h5><a class="pull-left-content" target="_blank" href="sme.html?sme='+valueobj.sme_id+'&'+sectorparameterString+'='+encodedSectorsString+'&'+countryparameterString+'='+encodedCountryString+'&score='+valueobj.total_score+'"><span>'+ valueobj.sme_id+ '</span><span> '+valueobj.location+ '</span></a></h5><hr class="hrclass"/>' )
