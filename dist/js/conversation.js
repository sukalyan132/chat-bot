  ...
  function displayMessage(newPayload, typeValue) {
    ...
    if (isUser !== null && textExists) {
      if( isUser)
        ...
        $('#resultlist').html('');
        $('#resultlist').append('<li><br/><br/><li class="media"  ><div class="media-body"><div class="media"><div class="media-body" > <a href="javascript:void(0);" id="setting" style="color: #00b4a0"><i class="fa fa-envelope faa-shake faa-fast animated fa-5x"></i>  </a></div></div> </div> </li>'); 
        }
        else
        {
        $('#resultlist').html('');
        $('#resultlist').append('<li><br/><br/> <li class="media"  ><div class="media-body"><div class="media"><div class="media-body" > <a href="javascript:void(0);" id="setting" style="color: #000000"><i class="fa fa-bell faa-ring animated faa-fast fa-5x"></i>  </a></div></div> </div> </li>'); 
        }
                       ...
                       'classNames': ['media' ] , 
                        'children':[{
                        ...
                        },
                         {
                            ...
                            'html' : (isUser ?  '<p class="watsonchattext" id="idtext_'+i+'" style="color:#00B4A0;">'+ msgoutput +'<br/><small class="text-muted">'+ (d.getDate()+','+monthNames[d.getMonth()]+' at '+d.getHours()+':'+d.getMinutes()+':'+d.getSeconds())+'</small></p > <hr />':  '<p class="watsonchattext" id="idtext_'+i+'" style="color:#ff3019;">'+ msgoutput +'<br/><small class="text-muted">'+(d.getDate()+','+monthNames[d.getMonth()]+' at '+d.getHours()+':'+d.getMinutes()+':'+d.getSeconds())+'</small></p><hr />') 
                        }
                        ]
                      }]
           }]
